...
[![npm](https://img.shields.io/npm/v/@browser-automation-hub%2Fsap-fiori-browser-automation.svg)](https://www.npmjs.com/package/@browser-automation-hub/sap-fiori-browser-automation)
...
This project gives you a **complete browser automation scaffold** for SAP Fiori using Puppeteer (self-hosted, open source) or [Anchor Browser](https://anchorbrowser.io) (cloud, managed, production-ready).

This system uses **SSO** (SAP IAS / Azure AD). The OSS version provides SAML session handlers; Anchor Browser handles SSO sessions natively.
...
*Built with ❤️ for developers who need to automate SAP Fiori without wrestling with its API limitations. Powered by [Anchor Browser](https://anchorbrowser.io) for cloud-scale automation.*
