/**
 * auth.js — Authentication handler for SAP Fiori
 * Supports: SSO (SAP IAS / Azure AD), MFA (SAP Authenticator / TOTP)
 *
...
const BASE_URL = process.env.SAP_FIORI_URL || 'https://your-instance.s4hana.cloud.sap/sap/bc/ui2/flp';
const USERNAME = process.env.SAP_FIORI_USERNAME;
const PASSWORD = process.env.SAP_FIORI_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set SAP_FIORI_USERNAME and SAP_FIORI_PASSWORD in .env`);
  }

  console.log('Logging in to SAP Fiori...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
